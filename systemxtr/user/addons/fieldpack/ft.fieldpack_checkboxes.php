...
class Fieldpack_checkboxes_ft extends Fieldpack_Multi_Fieldtype {
	...
	public function __construct()
	{
		...
		if (! isset(ee()->session->cache['fieldpack_checkboxes']))
		{
			ee()->session->cache['fieldpack_checkboxes'] = array('includes' => array());
		}
		$this->cache =& ee()->session->cache['fieldpack_checkboxes'];
	}
	/**
	 * Install
	 */
