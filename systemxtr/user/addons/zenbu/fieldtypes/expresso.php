...
class Zenbu_expresso_ft extends Base
{
	...
	*/
	...
	{
		return $this->display->text($data, $field_id, $settings);
	}
	...
	*/
	public function zenbu_field_extra_settings($table_col, $channel_id, $extra_options)
	{
		...
		$output['text_option_1'] = form_label(ee()->lang->line('show').NBS.form_input('settings['.$channel_id.']['.$table_col.'][text_option_1]', $extra_text_option_1, 'size="2" maxlength="4" class="bottom-margin"').'&nbsp;'.ee()->lang->line('characters')).'<br /><br />';
