...
'ci:actions:cover'	=>	'Naslovna slika',
'ci:actions:move'	=>	'Promijeni redoslijed',
'ci:actions:del'	=>	'Obriši',
...
// PBF
'ci:upload_images'	=>	'Prenesite slike',
'ci:stored_images'	=>	'Spremljene slike',
'ci:time_remaining'	=>	'Preostalo vrijeme',
'ci:stop_upload'	=>	'Zaustavi prijenos slika',
...
'ci:no_images'		=>	'Nijedna slika još nije prenesena.',
'ci:site_is_offline'=>	'Site is OFFLINE! Uploading images will/might not work.',
'ci:image_remain'	=>	'Preostalo slika:',
...
'ci:drophere'           =>	'Ispustite svoje slike ovdje ....',

'ci:json:click2edit'		=> '<span>Click to edit..</span>',
'ci:json:mouseenter2edit'	=> '<span>Hover to edit..</span>',
'ci:json:file_limit_reached'=> 'POGREŠKA: dosegnuto ograničenje slika',
'ci:json:xhr_reponse_error'	=> "Odgovor poslužitelja nije bio očekivan, vjerojatno pogreška u PHP-u. <a href='#' class='OpenError'>PRIKAŽI POGREŠKU</a>",
'ci:json:xhr_status_error'	=> "Zahtjev za prijenos nije uspio, nema HTTP 200 povratnog koda! <a href='#' class='OpenError'>PRIKAŽI POGREŠKU</a>",
'ci:json:del_file'			=> "Jeste li sigurni da želite izbrisati ovu sliku? \nSavjet: Pritisnite SHIFT prije nego kliknete da biste izbrisali sve slike odjednom",
'ci:json:unlink_file'		=> 'Jeste li sigurni da želite prekinuti povezanost ove slike?',
'ci:json:del_file_all'          => 'Jeste li sigurni da želite izbrisati sve slike?',
'ci:json:linked_force_del'	=> "Ta je slika povezana s drugim sadržajima, jeste li sigurni da ju želite izbrisati? \nOstale reference će se također izbrisati!",
'ci:json:submitwait'		=> 'Vaše se prenesene slike pohranjuju. Ovo može potrajati, ovisno o veličini slika.',

'ci:add_image'		=>	'Dodaj sliku',
'ci:caption_text'	=>	'Opis slike:',
