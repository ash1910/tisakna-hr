...
require_once PATH_THIRD.'fieldpack/helpers/eeharbor_abstracted.php';
...
class EEHelper extends \fieldpack\EEHarbor_abstracted {
	...
	private function initiateSettings()
	{
		...
		$addonSettings = require PATH_THIRD.'fieldpack/addon.setup.php';
	...
	private function settings_initiated()
	{
		...
		if(isset(ee()->session) && ee()->session->cache($this->_module, "settings", false))
		{
