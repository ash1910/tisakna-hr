...
'cf:actions:cover'	=>	'Naslovna datoteka',
'cf:actions:move'	=>	'Promijeni redoslijed',
'cf:actions:del'	=>	'Obriši',
...
// PBF
'cf:drophere'           =>	'Ispustite svoje datoteke ovdje....',
'cf:file_remain'        =>	'Preostalo datoteka:',
'cf:missing_settings'   =>	'Missing Channel Files settings for this field.',
'cf:no_files'           =>	'Nijedna datoteka još nije prenesena.',
...
'cf:upload_files'	=>	'Prenesite dokumente',
'cf:stored_files'	=>	'Pohranjene datoteke',
'cf:stop_upload'	=>	'Zaustavi prijenos datoteka',
'cf:row_num'		=>	'#',
'cf:id'				=>	'ID',
'cf:title'			=>	'Title',
'cf:desc'			=>	'Description',
...
'cf:json:file_limit_reached'=> 'POGREŠKA: dosegnuto ograničenje datoteka',
'cf:json:xhr_reponse_error'	=> "Odgovor poslužitelja nije bio očekivan, vjerojatno pogreška u PHP-u. <a href='#' class='OpenError'>PRIKAŽI POGREŠKU</a>",
'cf:json:xhr_status_error'	=> "Zahtjev za prijenos nije uspio, nema HTTP 200 povratnog koda! <a href='#' class='OpenError'>PRIKAŽI POGREŠKU</a>",
'cf:json:del_file'			=> 'Jeste li sigurni da želite izbrisati ovu datoteku?',
'cf:json:unlink_file'		=> 'Jeste li sigurni da želite prekinuti povezanost ove datoteke?',
'cf:json:linked_force_del'	=> "Ta je datoteka povezana s drugim sadržajima, jeste li sigurni da ju želite izbrisati? \nOstale reference će se također izbrisati!",
'cf:json:submitwait'		=> 'Vaše se prenesene datoteke pohranjuju. Ovo može potrajati, ovisno o veličini datoteka.',
