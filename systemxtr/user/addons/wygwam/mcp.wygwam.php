...
class Wygwam_mcp {
	...
	function index()
	{
		...
		foreach ($configModels as $model)
		{
			$configs[] = array(
				...
				'delete' => Helper::getMcpUrl('index', array('delete' => $model->config_id)),
			);
		}
	 ...
	 * Settings
	 */
	function settings($validationResult = null)
	{
