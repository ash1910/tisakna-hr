...
class Gmaps_ft_upd_161
{
	...
	public function run_update()
	{
		...
		$version->settings['gmaps_fieldtype_max_markers'] = '';
		$version->settings['gmaps_fieldtype_show_map_tools'] = '1';
		$version->settings['gmaps_fieldtype_show_search_tools'] = '1';
