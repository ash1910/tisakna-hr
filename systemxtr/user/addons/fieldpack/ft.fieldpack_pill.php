...
class Fieldpack_pill_ft extends Fieldpack_Fieldtype {
	...
	function __construct()
	{
		...
		$this->cache =& ee()->session->cache['fieldpack_pill'];
	}
	...
	function display_settings($data)
	{
        ...
        return $this->_package_display_settings('field_options_fieldpack_pill', "fieldpack_pill");
	...
	{
		$options = ee()->input->post('pt_pill_options');
	...
	function display_field($data, $cell = FALSE)
	{
		...
		$ee_version = "ee".$this->eeharbor->getEEVersion(true);

		$this->_insert_js('$( ".pt-pill" ).addClass( "'.$ee_version.'" );');
