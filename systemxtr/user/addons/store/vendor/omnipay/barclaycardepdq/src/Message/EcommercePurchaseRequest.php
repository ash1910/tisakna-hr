...
class EcommercePurchaseRequest extends AbstractRequest
{
    ...
    public function getData()
    {
        ...
        //----------------------------------------
        if ($this->httpRequest->request->get('epdq_pm')) {
            $data['PM'] = $this->httpRequest->request->get('epdq_pm');
        }

        if ($this->httpRequest->request->get('epdq_brand')) {
            $data['BRAND'] = $this->httpRequest->request->get('epdq_brand');
        }
