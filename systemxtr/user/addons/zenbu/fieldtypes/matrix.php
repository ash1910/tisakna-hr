				...
				foreach($col_array as $col_id => $col_data)
				{
					if(substr($col_id, 0, 7) == "col_id_")
					{
						...
						switch ($vars['column_fieldtype'][$num_col_id])
						{
							...
							break;
							case "assets":
								$ft_object = $this->fieldsObj->loadFieldtypeClass('assets');
								$cell = '';
							...
							case "date": case "dropdate":
								...
								$cell = $this->display->date($col_data, $field_id, $settings);
							break;
							case "playa": case "structure_playa":
								...
								$ft_object = $this->fieldsObj->loadFieldtypeClass($vars['column_fieldtype'][$num_col_id]);
							...
							break;
							default:
								$cell = $this->display->text($col_data, $field_id, $settings);
							break;
						}
