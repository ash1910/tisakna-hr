...
<div class="store_field_pane">
    <div id="store_product_stock">
        ...
        <script type="text/html" id="store_stock_row_template" class="store_stock_row_template"> 
        ...
        <script type="text/html" id="store_stock_row_th_template" class="store_stock_row_th_template">
            <th>
