...
class Ajw_feed extends Datagrab_type {
	...
	var $datatype_info = array(
		...
		'version'	=> '0.9',
    'description' => '<span class="st-warning">Warning</span><br/><br/>This uses a very old 3rd party RSS library. The XML datatype <br/>is recommended instead. This datatype is retained for backwards compatibility.',
		'allow_subloop' => TRUE
	);
